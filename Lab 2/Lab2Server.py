...
def main():
    ...
    while 1:
        ...
        # Check the credential files to see whether the username exists and passwords matches
        # Construct the login response message and encrypt it before sending back to the client
